...
function CombineXML(studentXML, InstructorXML){

const parser = new XMLParser();

let studentString = studentXML.toString();
let studentJSON = parser.parse(studentString);
const result = XMLValidator.validate(studentString, {
...
let instructorString = InstructorXML.toString();
  
  let instructorJSON = parser.parse(instructorString);
  const result2 = XMLValidator.validate(instructorString, {
      allowBooleanAttributes: true
  });
